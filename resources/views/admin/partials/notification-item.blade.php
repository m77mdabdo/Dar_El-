@php
    ...
    [$djLabel, $djMessage, $djUrl] = match ($djType) {
        ...
        'invoice_generation_failed' => [
            __('admin.notifications.type_invoice_generation_failed'),
            trim(($djData['order_number'] ?? '').' — '.($djData['error'] ?? '')),
            isset($djData['order_id']) ? route('admin.orders.show', $djData['order_id']) : null,
        ],
    ...
    $djIconByType = [
        ...
        'invoice_generation_failed' => ['bg' => 'rgba(156,80,100,.15)', 'fg' => '#9C5064', 'path' => 'M12 9v3.75m-9.303 3.376c-.866 1.5.217 3.374 1.948 3.374h14.71c1.73 0 2.813-1.874 1.948-3.374L13.949 3.378c-.866-1.5-3.032-1.5-3.898 0L2.697 16.126ZM12 15.75h.007v.008H12v-.008Z'],
